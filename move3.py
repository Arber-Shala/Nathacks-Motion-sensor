...
class Point:
   ...
   def shape(self):
      ...
      if self.velocity[0] == 0 and self.velocity[1] == 0:
         #self.vert_1 = True
         #while self.vert_1 == True:
         self.vertices.append(self.center[0])
         self.vertices.append(self.center[1])
         #self.vert_1 = False
         
      for i in range(0,7):
         if self.verticies[0] < self.vertices[2]:
            self.vert_1 = True
            
         if self.verticies[3] > self.vertices[5]:
            self.vert_2 = True
            
         if self.verticies[6] < self.vertices[4]:
            self.vert_3 = True
         
         if self.verticies[1] > self.verticies[7]:
            self.vert_4 = True
            
      if self.vert_1 == True and self.vert_2 == True and self.vert_3 == True and self.vert_4 == True:
         print("Rectangle")
         
         
         #self.verticies.append(self.velocity[0], self.velocity[1])
